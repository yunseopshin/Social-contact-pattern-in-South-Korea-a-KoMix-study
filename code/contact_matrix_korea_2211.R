...
data = read.csv('Kstat 코로나19 이후 접촉도 변화 조사_4차(22년 10월)_Data.csv',fileEncoding = "euc-kr")
library(stringr)

colnames(data)
contact_num_index = seq(from=43,342,by=6) # maximum 50
...
setwd('C:/Users/Hwichang Jeong/Desktop/corona_정리/corona/Kstat_contact_matrix/Kstat')
write.csv(phi,'./contact matrix/IBUKA/2022/contact_2210_IBUKA.csv')
write.csv(phi_mask_low,'./contact matrix/IBUKA/2022/contact_2210_IBUKA_mask_low.csv')
write.csv(phi_mask_high,'./contact matrix/IBUKA/2022/contact_2210_IBUKA_mask_high.csv')
write.csv(contact_kor,'./contact matrix/Sebastian/2022/contact_2210_Sebastian.csv')
write.csv(contact_kor_mask_low,'./contact matrix/Sebastian/2022/contact_2210_Sebastian_mask_low.csv')
write.csv(contact_kor_mask_high,'./contact matrix/Sebastian/2022/contact_2210_Sebastian_mask_high.csv')
