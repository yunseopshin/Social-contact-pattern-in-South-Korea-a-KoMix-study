...
data = read.csv('Kstat 코로나19 이후 접촉도 변화 조사_5차(23년 6월)_Data.csv',fileEncoding = "euc-kr")
library(stringr)
library(dplyr)

colnames(data)
contact_num_index = seq(from=29,328,by=6) # maximum 50
...
contact_data = data[,c(10,15,27,contact_num_index,23,26,20,22)]
...
setwd('C:/Users/Hwichang Jeong/Desktop/corona_정리/corona/Kstat_contact_matrix/Kstat')
write.csv(phi,'./contact matrix/IBUKA/2023/contact_2306_IBUKA.csv')
write.csv(phi_mask_low,'./contact matrix/IBUKA/2023/contact_2306_IBUKA_mask_low.csv')
write.csv(phi_mask_high,'./contact matrix/IBUKA/2023/contact_2306_IBUKA_mask_high.csv')
write.csv(phi_vaccine,'./contact matrix/IBUKA/2023/contact_2306_IBUKA_flu_vaccine.csv')
write.csv(phi_no_vaccine,'./contact matrix/IBUKA/2023/contact_2306_IBUKA_no_flu_vaccine.csv')
write.csv(phi_covid_infect,'./contact matrix/IBUKA/2023/contact_2306_IBUKA_covid_infect.csv')
write.csv(phi_no_covid_infect,'./contact matrix/IBUKA/2023/contact_2306_IBUKA_no_covid_infect.csv')
write.csv(phi_covid_vaccine,'./contact matrix/IBUKA/2023/contact_2306_IBUKA_covid_vaccine.csv')
write.csv(phi_no_covid_vaccine,'./contact matrix/IBUKA/2023/contact_2306_IBUKA_no_covid_vaccine.csv')

write.csv(phi_res_sb,'./contact matrix/Sebastian/2023/contact_2306_Sebastian.csv')
write.csv(phi_res_sb_mask_low,'./contact matrix/Sebastian/2023/contact_2306_Sebastian_mask_low.csv')
write.csv(phi_res_sb_mask_high,'./contact matrix/Sebastian/2023/contact_2306_Sebastian_mask_high.csv')
write.csv(phi_res_sb_flu_vaccine,'./contact matrix/Sebastian/2023/contact_2306_Sebastian_flu_vaccine.csv')
write.csv(phi_res_sb_no_flu_vaccine,'./contact matrix/Sebastian/2023/contact_2306_Sebastian_no_flu_vaccine.csv')
write.csv(phi_res_sb_covid_infect,'./contact matrix/Sebastian/2023/contact_2306_Sebastian_covid_infect.csv')
write.csv(phi_res_sb_no_covid_infect,'./contact matrix/Sebastian/2023/contact_2306_Sebastian_no_covid_infect.csv')
write.csv(phi_res_sb_covid_vaccine,'./contact matrix/Sebastian/2023/contact_2306_Sebastian_covid_vaccine.csv')
write.csv(phi_res_sb_no_covid_vaccine,'./contact matrix/Sebastian/2023/contact_2306_Sebastian_no_covid_vaccine.csv')
